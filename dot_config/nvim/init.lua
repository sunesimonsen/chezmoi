...
vim.keymap.set('n', '<leader>wh', '<C-w>h', { desc = 'Window rigth' })
...
vim.keymap.set('n', '<leader>bl', '<C-^>', { desc = 'Alternate file' })
vim.keymap.set('n', '<leader>bd', ':bd<CR>', { desc = 'Delete buffer' })

-- Vim files

vim.keymap.set('n', '<leader>ve', ':e $MYVIMRC<cr>', { desc = 'Vim config' })
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>cd', vim.lsp.buf.hover, 'Docs for symbol')
  ...
  { 'voldikss/vim-floaterm', config = function() end },
